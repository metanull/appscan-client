...
async function exploreGraphSecurity() {
  ...
  try {
    ...
    try {
      ...
      if (alerts.length > 0) {
        ...
        alerts.slice(0, 3).forEach((alert, i) => {
          ...
          console.log(`     Severity: ${alert.severity}, Status: ${alert.status}`);
      ...
      if (error.statusCode === 403) {
        console.log('   Permission issue - requires SecurityEvents.Read.All or SecurityEvents.ReadWrite.All');
      }
    }
    console.log();
    ...
    try {
      ...
      if (scores.length > 0) {
        ...
        scores.forEach((score, i) => {
          ...
          console.log(`     Current: ${score.currentScore}, Max: ${score.maxScore}`);
    ...
    console.log();
    console.log('Note: Updates require SecurityEvents.ReadWrite.All permission');
    console.log();
    ...
    console.log('  - ThreatIndicators.ReadWrite.OwnedBy: Manage threat indicators');
    console.log();
    ...
    console.log('    2. Advanced Security API endpoints (implemented in azdo-*.js)');
    console.log();
    ...
    console.error('     - Azure Active Directory > App registrations > New registration');
    console.error();
