...
const MinimalTest = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      'Test 1: Minimal TextInput (no Modal/Panel)'
    ),
    React.createElement(
      Text,
      { dimColor: true },
      'Type rapidly and observe lag. Press Enter when done, ESC to quit.'
    ),
    React.createElement(
      Box,
      { marginTop: 1 },
...
const NestedBoxTest = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      Text,
      { bold: true, color: 'cyan' },
      'Test 2: TextInput with nested Boxes (simulating Modal/Panel)'
    ),
    React.createElement(
      Text,
      { dimColor: true },
      'Type rapidly and compare lag to Test 1. ESC to quit.'
    ),
    React.createElement(
      Box,
      { marginTop: 1, borderStyle: 'double', borderColor: 'cyan', padding: 2 },
      React.createElement(
        Box,
        {
          flexDirection: 'column',
...
const MultiComponentTest = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      Text,
      { bold: true, color: 'cyan' },
      'Test 3: TextInput with multiple updating components'
    ),
    React.createElement(
      Text,
      { dimColor: true },
      'Other components update on keystroke. Observe lag difference. ESC to quit.'
    ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          null,
          'Uppercase: ',
          React.createElement(Text, null, value.toUpperCase())
        )
      )
    ),
    ...
    React.createElement(
      Box,
      { marginTop: 1, borderStyle: 'double', borderColor: 'green', padding: 1 },
      React.createElement(
        Box,
        { flexDirection: 'column' },
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          null,
          'Has uppercase: ',
          React.createElement(Text, null, /[A-Z]/.test(value) ? 'Yes' : 'No')
        ),
        React.createElement(
          Text,
          null,
          'Has numbers: ',
          React.createElement(Text, null, /[0-9]/.test(value) ? 'Yes' : 'No')
        )
      )
    )
  );
...
const FullScreenTest = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      Box,
      { borderStyle: 'single', paddingX: 1, flexShrink: 0 },
      React.createElement(
        Text,
        { bold: true, color: 'cyan' },
        `Test 4: FULL SCREEN (${columns}x${rows}) with Multiple Components`
      )
    ),
    ...
    React.createElement(
      ...
      React.createElement(
        Text,
        { dimColor: true },
        'Type rapidly in FULL SCREEN layout. ESC to quit.'
      ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Text,
          { bold: true },
          `Test 5: FULL SCREEN (${columns}x${rows}) - Background App`
        )
      ),
      React.createElement(
        Box,
        ...
        React.createElement(
          Text,
          { dimColor: true },
          'Simulating a list of items that would normally be here...'
        ),
        React.createElement(
          Box,
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Text,
          { bold: true, color: 'cyan' },
          '📝 Modal: Add Comment (Overlay on Full Screen)'
        ),
        React.createElement(
          Text,
          { dimColor: true, marginTop: 1 },
          'Type in this modal overlay. Observe lag. ESC to quit.'
        ),
        ...
        React.createElement(
          ...
          React.createElement(
            Text,
            null,
            'Add comment (optional, press Enter to submit):'
          ),
          React.createElement(
            Box,
            { marginTop: 1 },
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Text,
          { bold: true },
          'Test 6: Modal WITHOUT Dark Overlay - Background'
        )
      ),
      React.createElement(
        Box,
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Text,
          { dimColor: true, marginTop: 1 },
          'Type here. Is there still lag? ESC to quit.'
        ),
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        Text,
        { bold: true, color: 'cyan' },
        '📝 Test 7: Modal with NO Background'
      ),
      React.createElement(
        Text,
        { dimColor: true, marginTop: 1 },
        'No background content, no overlay. Still lag? ESC to quit.'
      ),
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        Text,
        { bold: true, color: 'cyan' },
        'Test 8: TextInput at BOTTOM (Task 3)'
      )
    ),
    ...
    React.createElement(
      ...
      React.createElement(
        Text,
        { dimColor: true },
        'All content ABOVE the input. Type at bottom. Still lag?'
      ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Text,
          { bold: true },
          'Test 9: Modal with MINIMAL Background (no filler)'
        )
      ),
      React.createElement(
        Box,
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Text,
          { bold: true, color: 'cyan' },
          '📝 Test 9: No Filler Box'
        ),
        React.createElement(
          Text,
          { dimColor: true, marginTop: 1 },
          'Background without filler. Still lag?'
        ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Text,
          { bold: true, color: 'cyan' },
          '📝 Test 10: Modal-sized Dark Background'
        ),
        React.createElement(
          Text,
          { dimColor: true, marginTop: 1 },
          'Dark box is ONLY modal size. Still lag?'
        ),
...
const tests = {
  ...
  9: {
    name: 'Modal with MINIMAL Background (no filler)',
    component: ModalMinimalBackgroundTest,
  },
