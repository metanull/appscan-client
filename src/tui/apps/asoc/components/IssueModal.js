...
import { MarkdownBox } from '../../../shared/components/MarkdownBox.js';
 ...
 * @param {Object} props.AsocService - Service for fetching additional issue data
 * @param {Object} props._config - Configuration object (unused but accepted)
 * @param {Function} props.onClose - Callback when modal is closed
 * @returns {JSX.Element|null}
 */
export const IssueModal = React.memo(
  ({ issue, app, articleContent, AsocService, _config, onClose }) => {
